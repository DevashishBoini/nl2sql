...
from backend.constants import LOG_LEVELS, ANTHROPIC_SONNET_45, EMBEDDING_MODEL_3_SMALL
...
class LLMConfig(BaseModel):
    ...
    default_model: str = ANTHROPIC_SONNET_45
...
class EmbeddingConfig(BaseModel):
    openrouter_api_key: str
    embedding_model: str = EMBEDDING_MODEL_3_SMALL
